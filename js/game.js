...
function updatePlayer(dt, $container) {
    ...
    if (
        ...
        GAME_STATE.lastStateSpacePressed === true
    ) {
...
function updateEnemies(dt, $container) {
    ...
    switch (GAME_STATE.level) {
        ...
        case 5: //Level 5
            ...
            break;
        case 6: //Level 6
            dy = dt * (ENEMY_SPEED * 3.0);
            break;
        case 7: //Level 7
            dy = dt * (ENEMY_SPEED * 3.25);
            break;
        case 8: //Level 8
            dy = dt * (ENEMY_SPEED * 3.50);
            break;
        case 9: //Level 9
            dy = dt * (ENEMY_SPEED * 4);
            break;
...
function initLevel(level) {
    ...
    if (enemyDist === undefined) {
        //If is out of all level then...
        enemyDist =
            TOLERABLE_ENEMY_DISTANCE[TOLERABLE_ENEMY_DISTANCE.length - 1];
    }
